<template>
	<div class="mainbox">
		<div class="cardbox">
			...
			<div class="gezi">
				<h3 style="color: #4f8fc3;line-height: 30px; padding-bottom: 10px;">累计数据统计</h3>
				<el-row :gutter="10">
					<el-col :span="6">
			...
			<div class="tablebox">
				...
				<div class="tableone">
					<el-table :data="tableData" style="width: 100%" max-height="250">
						<el-table-column fixed prop="blockNumber" label="区块高度" width="120">
						</el-table-column>
...
<script>
	export default {
		...
		methods: {
			...
			async getTableData() {
				const { data: res} = await this.$http.get('/api7/tpl/cross_origin.php?interface=getTopNBlockInfo&protocol=CORS')
				console.log(res)
