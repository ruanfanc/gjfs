<template>
  <div class="mainbox">
    <div class="cardbox">
      ...
      <div class="tablebox">
        <h3 style="color: #4f8fc3;line-height: 30px;">最新操作通知</h3>
        <div class="tableone">
          <el-table :data="messageData" style="width: 100%" max-height="300">
            <el-table-column
              fixed
              prop="evidencId"
              label="证据编号"
            ...
            <el-table-column prop="value" label="操作事件" width="400">
            </el-table-column>
          </el-table>
        </div>
      </div>
